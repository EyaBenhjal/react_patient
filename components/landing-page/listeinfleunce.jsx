...
const Listinfleunce = () => {
  const data = [
    {
      imgSrc: "/images/instructor/instructor09.png",
          ...
          <div className="instructor__content">
            <div className="left">
              ...
              <h4 className="name" style={{ color: "white" }}>
                <Link href="/auth/aboutinfleunce" style={{ color: "white" }}>{name}</Link>
              </h4>
            </div>
            <div className="right">
